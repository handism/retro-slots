...
- [project_fantasy_slot.md](./project_fantasy_slot.md) — Fantasy Slot プロジェクトの基本仕様・設計方針・実装進捗
- [decision_20260321_scriptableobject_creator.md](./decision_20260321_scriptableobject_creator.md) — ScriptableObject アセット一括生成スクリプトの設計・リールストリップ枚数構成
