...
namespace SlotGame.View
{
    ...
    public class SymbolView : MonoBehaviour
    {
        ...
        public void StopPulseAnimation()
        {
            ...
            {
                try { _pulseTween.Kill(); } catch (System.Exception e) { Debug.LogWarning($"Exception when killing pulse tween: {e.Message}"); }
            }
            _pulseTween = null;
        ...
        public void PlayIdleAnimation()
        {
            ...
            if (_animator != null)
            {
                try { _animator.Play(IdleStateName, 0, 0f); } catch (System.Exception e) { Debug.LogWarning($"Exception when playing idle animation: {e.Message}"); }
            }
        }
