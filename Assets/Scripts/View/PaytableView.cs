...
namespace SlotGame.View
{
    ...
    public class PaytableView : MonoBehaviour
    {
        ...
        [SerializeField]
        private HorizontalLayoutGroup headerRowLayoutGroup;
        ...
        public void Populate(SymbolData[] symbols, PayoutTableData payoutData)
        {
            ...
            if (headerRowLayoutGroup != null)
            {
                ApplyHeaderRowLayout(headerRowLayoutGroup);
            }
            else
            {
                // Fallback for backwards compatibility if reference is missing
                foreach (var hlg in GetComponentsInChildren<HorizontalLayoutGroup>(true))
                {
                    if (hlg.gameObject.name != "HeaderRow")
                        continue;
                    ApplyHeaderRowLayout(hlg);
                    break;
                }
            }
        ...
        private void ApplyHeaderRowLayout(HorizontalLayoutGroup hlg)
        {
